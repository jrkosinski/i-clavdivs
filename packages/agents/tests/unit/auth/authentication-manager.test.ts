...
import type { IAuthProfileConfig, IApiKeyCredential, ITokenCredential, IOAuthCredential } from '../../../src/auth/types.js';
...
describe('AuthenticationManager', () => {
  ...
  describe('authenticate', () => {
    ...
    describe('with multiple profiles', () => {
      beforeEach(() => {
        store.upsertProfile('anthropic-1', { type: 'api_key', provider: 'anthropic', key: 'key1' });
        store.upsertProfile('anthropic-2', { type: 'api_key', provider: 'anthropic', key: 'key2' });
        store.upsertProfile('anthropic-3', { type: 'api_key', provider: 'anthropic', key: 'key3' });
      });
  ...
  describe('recordSuccess', () => {
    beforeEach(() => {
      store.upsertProfile('profile-1', { type: 'api_key', provider: 'anthropic', key: 'key1' });
    });
