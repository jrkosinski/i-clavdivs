...
describe('FailoverError', () => {
  ...
  describe('httpStatus', () => {
    ...
    it('should return 429 for rate_limit errors', () => {
      const error = new FailoverError('Too many requests', 'rate_limit', 'test', 'test-model');
    ...
    it('should return 413 for context_overflow errors', () => {
      const error = new FailoverError('Context too large', 'context_overflow', 'test', 'test-model');
