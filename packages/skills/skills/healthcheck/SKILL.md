---
name: healthcheck
description: Host security hardening and risk-tolerance configuration for i-clavdivs deployments. Use when a user asks for security audits, firewall/SSH/update hardening, risk posture, exposure review, i-clavdivs cron scheduling for periodic checks, or version status checks on a machine running i-clavdivs (laptop, workstation, Pi, VPS).
---
